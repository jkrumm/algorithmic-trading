...
function createDashboard() {
    ...
    piwikHelper.modalConfirm(makeSelectorLastId('createDashboardConfirm'), {
        yes: function () {
...
function resetDashboard() {
    piwikHelper.modalConfirm(makeSelectorLastId('resetDashboardConfirm'), {
        yes:
            function () {
                $('#dashboardWidgetsArea').dashboard('resetLayout');
            }
    });
}
...
function renameDashboard() {
    ...
    piwikHelper.modalConfirm(makeSelectorLastId('renameDashboardConfirm'), {
        yes: function () {
...
function removeDashboard() {
    ...
    piwikHelper.modalConfirm(makeSelectorLastId('removeDashboardConfirm'), {
        yes: function () {
