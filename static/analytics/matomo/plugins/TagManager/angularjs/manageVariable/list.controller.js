...
(function () {
    ...
    function VariableListController($scope, tagManagerVariableModel, piwik, piwikApi, $location) {
        ...
        this.deleteVariable = function (variable) {
            ...
            piwikApi.fetch({
                method: 'TagManager.getContainerVariableReferences', idContainer: this.idContainer,
                idContainerVersion: this.idContainerVersion, idVariable: variable.idvariable
