...
async def run1(results=results):
    ...
    results_sum = res[
        ["duration_days", "net_profit", "gross_profit", "daily_return", "monthly_return", "yearly_return",
         "buy_hold", "win_rate", "win_loss_ratio", "largest_win", "avg", "avg_win"]].copy().max().to_frame().T
    ...
    results_sum["avg_lost"] = res[["avg_lost"]].copy().min().to_frame().T
    ...
    results_sum["avg_days"] = res["avg_days"].mean()
    ...
    results_sum = results_sum[
        ['index', 'first_signal', 'duration_days', 'net_profit', 'gross_profit', 'gross_lost',
         ...
         'win_rate', 'win_loss_ratio', 'largest_win', 'largest_lost', 'avg', 'avg_win', 'avg_lost', 'avg_days']]
    ...
    #      'win_loss_ratio', 'avg', 'avg_win', 'avg_lost', 'avg_days']].copy()
